-- This SQL script updates tables and policies, handling the case where they already exist
...
-- ==================== PROBLEM REPORTS ====================
-- Create problem_reports table if it doesn't exist
...
-- Create policy to allow authenticated users to insert sprints
...
-- Create policy to allow authenticated users to update sprints
...
-- Create policy to allow authenticated users to update challenges
...
-- ==================== SAMPLE DATA ====================
-- Insert sample data for sprints
