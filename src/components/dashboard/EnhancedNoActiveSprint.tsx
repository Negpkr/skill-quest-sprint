...
interface EnhancedNoActiveSprintProps {
  hasCompletedSprints: boolean;
}

const EnhancedNoActiveSprint: React.FC<EnhancedNoActiveSprintProps> = ({
  hasCompletedSprints
}) => {
  return (
    <div className="w-full py-16 px-8 flex flex-col items-center justify-center text-center">
      ...
      <h2 className="text-3xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500">
        {hasCompletedSprints ? "Start Your Next Sprint" : "Start Your First Sprint"}
      </h2>

      <p className="text-muted-foreground max-w-md mb-8">
        {hasCompletedSprints
          ? "You don't have any active skill sprints right now. Choose a new 30-day challenge to continue building your skills."
...
export default EnhancedNoActiveSprint;
